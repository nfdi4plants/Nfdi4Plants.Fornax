 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const o=Symbol.for(""),e=t=>{var r,e;if((null===(r=t)||void 0===r?void 0:r.r)===o)return null===(e=t)||void 0===e?void 0:e._$litStatic$},i=t=>({_$litStatic$:t,r:o}),a=new Map,s=t=>(r,...o)=>{const i=o.length;let l,s;const n=[],u=[];let c,v=0,$=!1;for(;v<i;){for(c=r[v];v<i&&void 0!==(s=o[v],l=e(s));)c+=l+r[++v],$=!0;u.push(s),n.push(c),v++;}if(v===i&&n.push(r[i]),$){const t=n.join("$$lit$$");void 0===(r=a.get(t))&&(n.raw=n,a.set(t,r=n)),o=u;}return t(r,...o)},n=s($);
...
let H1 = class extends s$1 {
  render() {
    return headerTemplate(i("h1"), toInDOMHref(this.textId), this.text);
  }
  connectedCallback() {
...
let H2 = class extends s$1 {
  render() {
    return headerTemplate(i("h2"), toInDOMHref(this.textId), this.text);
  }
  connectedCallback() {
    super.connectedCallback();
    setTimeout(() => {
...
let H3 = class extends s$1 {
  render() {
    return headerTemplate(i("h3"), toInDOMHref(this.textId), this.text);
  }
  connectedCallback() {
    super.connectedCallback();
    setTimeout(() => {
...
let H4 = class extends s$1 {
  render() {
    return headerTemplate(i("h4"), toInDOMHref(this.textId), this.text);
  }
  connectedCallback() {
    super.connectedCallback();
    setTimeout(() => {
...
let H5 = class extends s$1 {
  render() {
    return headerTemplate(i("h5"), toInDOMHref(this.textId), this.text);
  }
  connectedCallback() {
    super.connectedCallback();
    setTimeout(() => {
...
let H6 = class extends s$1 {
  render() {
    return headerTemplate(i("h6"), toInDOMHref(this.textId), this.text);
  }
  connectedCallback() {
    super.connectedCallback();
    setTimeout(() => {
